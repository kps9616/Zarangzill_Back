    ...
    <div class="container-full">
        <div class="tab-nav">
            <ul>
                ...
                <li><a href="${path}/99-1멤버.html" class="on">멤버</a></li>
                ...
                <ul>                   
                    <li>                    
                       <span class="mym-icon" uk-icon="cog"></span>
                        <div class="mym-img"><img src="${path}/images/thum/face01.jpg"></div>                   
                        <div class="mym-name">지효</div>
                        <div class="mym-cog"><a href="${path}/#modal-sections" class="c_blue" uk-toggle>권한 넘기기</a></div>
                    </li>
                    <li>
                         <div class="mym-img"><img src="${path}/images/thum/face02.jpg"></div>                   
                         <div class="mym-name">나연</div>
                         <div class="mym-cog"><a href="${path}/#modal-sections2" uk-toggle><span uk-icon="icon:close"></span></a></div>
                     </li>
                     <li> 
                         <div class="mym-img"><img src="${path}/images/thum/grup03.jpg"></div>                   
                         <div class="mym-name">안유진</div>
                         <div class="mym-cog"><a href="${path}/#" class="c_red">취소</a></div>
                     </li>
                     <li>       
                        <div class="mym-invte">
                            <span uk-icon="icon:plus-circle"> </span>
                            <a href="${path}/#modal-sections3" class="c_blue ml5" uk-toggle>초대하기</a>
                        </div>
                    </li>
                </ul>
            </div>        
