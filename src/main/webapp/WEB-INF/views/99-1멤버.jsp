    ...
    <div class="container-full">
        <div class="tab-nav">
            <ul>
                ...
                <li><a href="99-1멤버.html" class="on">멤버</a></li>
                <li><a href="101-1팬.html">팬</a></li>
            </ul>
        </div>
        <style>
        ...
        <!--container-->
        <div class="container">
            <h3 class="mt10 pb10 bline">멤버 : 3명</h3>
            <div class="mych-member mt20">
                <ul>                   
                    <li>                    
                       <span class="mym-icon" uk-icon="cog"></span>
                        <div class="mym-img"><img src="${path}/resources/images/thum/face01.jpg"></div>                   
                        <div class="mym-name">지효</div>
                        <div class="mym-cog"><a href="#modal-sections" class="c_blue" uk-toggle>권한 넘기기</a></div>
                    </li>
                    <li>
                         <div class="mym-img"><img src="${path}/resources/images/thum/face02.jpg"></div>                   
                         <div class="mym-name">나연</div>
                         <div class="mym-cog"><a href="#modal-sections2" uk-toggle><span uk-icon="icon:close"></span></a></div>
                     </li>
                     <li> 
                         <div class="mym-img"><img src="${path}/resources/images/thum/grup03.jpg"></div>                   
                         <div class="mym-name">안유진</div>
                         <div class="mym-cog"><a href="#" class="c_red">취소</a></div>
                     </li>
                     <li>       
                        <div class="mym-invte">
                            <span uk-icon="icon:plus-circle"> </span>
                            <a href="#modal-sections3" class="c_blue ml5" uk-toggle>초대하기</a>
                        </div>
                    </li>
                </ul>
            </div>        
