        ...
        <form id="form1" name="form1" method="post">
            ...
            <ul class="form-create">
                <li class="photo">
                    ...
                    <img src="${path}/images/thum/face02.jpg" id="imagePreview">
                    <div uk-form-custom>
                ...
                <li>
                    <input class="uk-input" type="text" placeholder="" value="${memberInfo.name}" aria-label="Input" name="name">
                </li>
                <li>
                    <label>생년월일</label>
                    <input class="uk-input w60" type="text" placeholder="20121212" aria-label="Input" value="${memberInfo.birthday}" name="birthday"> -
                    <c:choose>
                    <c:when test="${memberInfo.gender eq 'M'}">
                        <input class="uk-input w10" type="text" placeholder="4" aria-label="Input" value="1" id="genderNo" name="genderNo"> ******
                    </c:when>
                    <c:otherwise>
                        <input class="uk-input w10" type="text" placeholder="4" aria-label="Input" value="2" id="genderNo" name="genderNo"> ******
                    </c:otherwise>
                    </c:choose>
                ...
                <li class="snsimg">
                    <h3>로그인 연동 Google</h3>
                    <img src="${path}/images/icon/google-g.png" class="on">
                    <img src="${path}/images/icon/apple.png">
                </li>
                --%>
            </ul>
                <button type="button" class="bt_gradient w100" onclick="fnSave(); return false;">회원정보 저장</button>
        </form>
    </div>
<%--
...
<div id="unregiste" class="uk-flex-top" uk-modal>
    <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical">
        ...
        <div class="uk-modal-footer uk-text-center">
            ...
            <button class="uk-button uk-button-danger ml20" type="button" onclick="fnMemberWithdrawal();">탈퇴</button>
        </div>
    </div>
</div>
</body>
