    ...
    <div class="bottom-modal top-radius" style="height:350px;">
        ...
        <div class="bttom-modal-con">
            <div class="login-btbx">
                <a href="/oauth2/authorization/google?redirect_uri=/signup/oauth2/code/google">
...
<div class="full-bottom-bar">
    <div class="v_bottom_nav">
        <ul>
            ...
            <li class="mcircle"><a href="#" class="vsicon"> <em uk-icon="icon: bottom03;"><i class="sr-only">촬영</i></em></a>
            </li>
            <li><a href="#" class="vsicon"><span uk-icon="icon: bottom04;"><i class="sr-only">팬</i></span></a></li>
            <li><a href="#" class="vsicon" id="btn-login"><span uk-icon="icon: bottomOn05;"><i class="sr-only">마이페이지</i></span></a>
            </li>
        </ul>
    </div>
