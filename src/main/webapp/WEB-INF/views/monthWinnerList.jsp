...
<script>
    ...
    function fn_createDiv() {
        ...
        $.ajax({
            url: 'http://1.226.83.35:9090/api/v1/win/month/list/old',
            method: 'GET',
            dataType: 'json',
            ...
            success: function(response) {
                ...
                for(var i = 0; i < winPredMList.length; i++) {
                    ...
                    if(i == 0 ) {
                        ...
                        html += '            <img src="${path}/resources/images/icon/m-winner.png">';
                        html += '        </div>';
                    }

                    html += '        <img src="${path}/resources/images/thum/thum0'+(i+1)+'.jpg" class="thum">';
                    html += '   </div>';
                    ...
                    html += '           <img class="small-thum mr5" src="${path}/resources/images/thum/face0'+(i+1)+'.jpg">';
