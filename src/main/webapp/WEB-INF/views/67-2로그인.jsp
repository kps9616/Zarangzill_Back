        ...
        <div class="bottom-modal top-radius"  style="height:350px;">
            ...
            <div class="bttom-modal-con">
                <div class="login-btbx">
                    <button type="button"><img src="${path}/images/icon/google-g.png" alt="구글로그인버튼"></button> 
                    <button type="button"><img src="${path}/images/icon/apple.png" alt="애플"></button> 
                </div>
                <div class="login-other">
                다른방법으로 <a href="${path}/#none" id="other-login-link">로그인</a>
                </div>
            </div>
        
            <div class="uk-modal-footer">
                <a href="${path}/68-2회원가입.html" class="btn-line-blue w100">회원가입</a>
            </div>
        </div>
    ...
    <div class="full-bottom-bar">
        <div class="v_bottom_nav">                
            <ul>
                ...
                <li><a href="${path}/#" class="vsicon"  id="btn-login"><span uk-icon="icon: bottomOn05;"><i class="sr-only">마이페이지</i></span></a></li>
            </ul>        
        </div>
