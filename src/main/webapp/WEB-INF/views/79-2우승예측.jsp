     ...
     <div class="swiper mySwiper">
       <div class="swiper-wrapper">        
         <div class="swiper-slide">
           ...
           <div class="swp-img rank-score" title="비디오 썸네일" style="background-image: url(images/thum/thum02.jpg);">
         ...
         <div class="swiper-slide  ">
            <div class="swp-img rank-score" title="비디오 썸네일" style="background-image: url(images/thum/thum03.jpg);">               
                <div class="rank-score-num"><img src="${path}/images/icon/m-winner.png"></div>
           </div>
           <div class="swp-info">
               <a href="${path}/#">
         ...
         <div class="swiper-slide">
            <div class="swp-img rank-score" title="비디오 썸네일" style="background-image: url(images/thum/thum01.jpg);">
         ...
         <div class="swiper-slide rank-score">
          ...
          <div class="swiper-slide">           
            <div class="swp-img filter-gray" title="비디오 썸네일" style="background-image: url(images/thum/thum03.jpg);">
                <!--삭제된비디오표시s-->
     ...
     <div class="swiper mySwiper mt40">
        <div class="swiper-wrapper">   
          ...
          <div class="swiper-slide">
            ...
            <div class="swp-img rank-score" title="비디오 썸네일" style="background-image: url(images/thum/thum04.jpg);">
                <div class="rank-score-num"><img src="${path}/images/icon/w-winner.png"></div>
           </div>
            <div class="swp-info">
                <a href="${path}/#">
                    <img src="${path}/images/thum/group04.jpg">
